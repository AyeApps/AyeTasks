  ...
  return (
    ...
    >
      ...
      {isDesktop ? (
        <>
          <TouchableOpacity
            style={styles.contentBodyDesktop}
                ...
                <TouchableOpacity
                  style={[
                    styles.headerIconBtn,
                    {
                      ...
                      // @ts-ignore
                      cursor: (Platform.OS === 'web' ? 'grab' : 'pointer') as any,
                    },
                  ]}
                  onPress={(e) => {
                    e?.stopPropagation?.();
                  ...
                  {...(Platform.OS === 'web'
                    ...
                    : {})}
                  activeOpacity={0.7}
                  accessibilityLabel={t.taskCard.moveDay || 'Mover de día'}
                >
                  <Hand
                    size={11}
                    color={colors.accent}
          ...
          <View style={styles.cardHeaderCompact}>
            ...
            <View style={styles.miniIndicatorRow}>
              ...
              <TouchableOpacity
                ...
                accessibilityLabel={t.taskCard.moveDay || 'Mover de día'}
              >
                <Hand size={10} color={colors.accent} strokeWidth={2.5} />
              </TouchableOpacity>
            </View>
          </View>
