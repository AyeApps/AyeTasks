  ...
  useEffect(() => {
    if (Platform.OS === 'web' && typeof document !== 'undefined') {
      ...
      styleTag.textContent = `
        ...
        /* Task Card Transitions (smooth synchronized theme color transitions + focus/dim motion) */
        .task-card-cyber, [data-role="task-card"] {
          transition: opacity 0.28s cubic-bezier(0.16, 1, 0.3, 1),
                      ...
                      stroke 350ms cubic-bezier(0.4, 0, 0.2, 1),
        ...
        /* Action Buttons Hover & Synchronized Theme Transition */
        ...
        /* 8. Master Synchronized 350ms Theme Fade Transition (Dark <-> Light) */
        body, html, #root, div, span, p, h1, h2, h3, h4, h5, h6, input, textarea, button, a, svg, svg *, [data-role="task-card"], [data-role="day-column"], [data-role="action-btn"] {
