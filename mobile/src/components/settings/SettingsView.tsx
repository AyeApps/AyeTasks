    ...
    <View style={[styles.container, { backgroundColor: colors.bgBase }]}>
      ...
      >
        <View style={[styles.centerWrapper, { maxWidth: isMobile ? '100%' : 780 }]}>
          ...
          {/* ── CARD 5: ABOUT AYETASKS (DATOS BÁSICOS Y ECOSISTEMA) ── */}
          <View
            style={[
              styles.card,
              styles.aboutCard,
          ...
          >
            ...
            {/* 1. Official Landing Page Section */}
            <View style={[styles.ecosystemSection, { borderTopColor: colors.borderMuted }]}>
              <Text style={[styles.ecosystemHeading, { color: colors.textMuted }]}>
                {t.settings.landingSectionTitle}
              </Text>

              <TouchableOpacity
                style={[
                  styles.ecosystemLinkBtn,
                  {
                ...
                onPress={() => Linking.openURL('https://tasks.ayeapps.com')}
                activeOpacity={0.7}
              >
                <View style={styles.ecosystemLinkLeft}>
                  <View style={[styles.ecosystemIconBadge, { backgroundColor: colors.accentSubtle, borderColor: colors.accent }]}>
                    <Globe size={14} color={colors.accent} strokeWidth={2.5} />
                  </View>
                  <View>
                    <Text style={[styles.ecosystemLinkTitle, { color: colors.textPrimary }]}>
                      {t.settings.visitLanding}
                    </Text>
                    <Text style={[styles.ecosystemLinkSub, { color: colors.accent }]}>
                      {t.settings.visitLandingSub}
                    </Text>
                  </View>
                </View>
            ...
            {/* 2. Other Apps & Suite Section */}
            <View style={[styles.ecosystemSection, { borderTopColor: colors.borderMuted }]}>
              <Text style={[styles.ecosystemHeading, { color: colors.textMuted }]}>
                {t.settings.otherAppsSectionTitle}
              </Text>

              <View style={styles.ecosystemLinksCol}>
                {/* AyeFinance */}
                <TouchableOpacity
                  style={[
                    styles.ecosystemLinkBtn,
                  ...
                  onPress={() => Linking.openURL('https://finance.ayeapps.com')}
                  activeOpacity={0.7}
                >
                  <View style={styles.ecosystemLinkLeft}>
                    <View style={[styles.ecosystemIconBadge, { backgroundColor: colors.accentSuccessSubtle, borderColor: colors.accentSuccess }]}>
                      <TrendingUp size={14} color={colors.accentSuccess} strokeWidth={2.5} />
                    </View>
                    <View>
                      <Text style={[styles.ecosystemLinkTitle, { color: colors.textPrimary }]}>
                        {t.settings.visitAyeFinance}
                      </Text>
                      <Text style={[styles.ecosystemLinkSub, { color: colors.textMuted }]}>
                        {t.settings.visitAyeFinanceSub}
                      </Text>
                    </View>
                  </View>
                  <ExternalLink size={14} color={colors.textMuted} strokeWidth={2.5} />
                </TouchableOpacity>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => Linking.openURL('https://video.ayeapps.com')}
                  activeOpacity={0.7}
                >
                  <View style={styles.ecosystemLinkLeft}>
                    <View style={[styles.ecosystemIconBadge, { backgroundColor: colors.accentSubtle, borderColor: colors.accent }]}>
                    ...
                    <View>
                      <Text style={[styles.ecosystemLinkTitle, { color: colors.textPrimary }]}>
                        {t.settings.visitAyeVideo}
                      </Text>
                      <Text style={[styles.ecosystemLinkSub, { color: colors.textMuted }]}>
                        {t.settings.visitAyeVideoSub}
                      </Text>
                    </View>
                  </View>
                  <ExternalLink size={14} color={colors.textMuted} strokeWidth={2.5} />
                ...
                <TouchableOpacity
                  ...
                  onPress={() => Linking.openURL('https://ayeapps.com')}
                  activeOpacity={0.7}
                >
                  <View style={styles.ecosystemLinkLeft}>
                    <View style={[styles.ecosystemIconBadge, { backgroundColor: colors.bgSurface, borderColor: colors.borderColor }]}>
                      <Layers size={14} color={colors.textPrimary} strokeWidth={2.5} />
                    </View>
                    <View>
                      <Text style={[styles.ecosystemLinkTitle, { color: colors.textPrimary }]}>
                        {t.settings.visitEcosystem}
                      </Text>
                      <Text style={[styles.ecosystemLinkSub, { color: colors.textMuted }]}>
                        {t.settings.visitEcosystemSub}
                      </Text>
                    </View>
                  </View>
                  <ExternalLink size={14} color={colors.textMuted} strokeWidth={2.5} />
